---
title: "Outbound HTTP Middleware"
description: "Inspect, mutate, forward, or answer HTTP requests made by code inside an agentOS VM."
skill: true
---
...
<CodeSnippet file="examples/outbound-http-middleware/forward.ts" />
...
<CodeSnippet file="examples/outbound-http-middleware/credentials.ts" />
...
<CodeSnippet file="examples/outbound-http-middleware/mock-llm.ts" />
...
<CodeSnippet file="examples/outbound-http-middleware/embedded-gateway.ts" />
