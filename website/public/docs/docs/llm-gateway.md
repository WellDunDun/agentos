...
For a working request-routing primitive today, see the [embedded gateway pattern in Outbound HTTP Middleware](/docs/outbound-http-middleware#embed-an-llm-gateway).